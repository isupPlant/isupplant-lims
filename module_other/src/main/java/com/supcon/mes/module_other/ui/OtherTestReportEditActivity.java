...
@Router(value = Constant.AppCode.LIMS_OtherTestReportEdit)
public class OtherTestReportEditActivity extends BaseRefreshActivity implements TestReportEditContract.View, StdJudgeSpecContract.View{
