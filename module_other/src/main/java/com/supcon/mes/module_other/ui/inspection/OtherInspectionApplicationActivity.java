...
public class OtherInspectionApplicationActivity extends BaseRefreshRecyclerActivity<InspectionApplicationEntity> implements InspectionApplicationContract.View {
    ...
    protected void initListener() {
        ...
        refreshListController.setOnRefreshPageListener(new OnRefreshPageListener() {
            ...
            public void onRefresh(int pageIndex) {
                presenterRouter.create(InspectionApplicationAPI.class).getInspectionApplicationList(LimsConstant.PleaseCheck.OTHER_PLEASE_CHECK, isWhole, pageIndex, params);
            }
        });
