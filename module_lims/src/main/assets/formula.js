...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.POWER = function(number, power) {
	  ...
	  var result = Math.pow( Number(s1.replace(".","")), power)/Math.pow(10,m*power);
	  if (isNaN(result)) {
	    return error.num;
	  }
	...
	exports.ADD = function (num1, num2) {
	  ...
	  return (exports.MULTIPLY(num1,m)+exports.MULTIPLY(num2,m))/m;
	};
	...
	exports.DIVIDE = function (dividend, divisor) {
	  ...
	  var t1=0,t2=0,r1,r2;
	  try{t1=dividend.toString().split(".")[1].length}catch(e){}
	  try{t2=divisor.toString().split(".")[1].length}catch(e){}
	  with(Math){
	...
	exports.MULTIPLY = function (factor1, factor2) {
	  ...
	  var m=0,s1=factor1.toString(),s2=factor2.toString();
	  try{m+=s1.split(".")[1].length}catch(e){}
	  try{m+=s2.split(".")[1].length}catch(e){}
	  factor1 = utils.parseNumber(s1.replace(".",""));
	  factor2 = utils.parseNumber(s2.replace(".",""));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AVERAGE = function() {
	  ...
	  for (var i = 0; i < n; i++) {
	    //sum += range[i];
		sum=formulajs.ADD(sum,range[i]);
	    count += 1;
	  }
	  return formulajs.DIVIDE(sum,count);
	};
	...
	exports.VAR.S = function() {
	  ...
	  var mean = exports.AVERAGE(range);
	  for (var i = 0; i < n; i++) {
	    sigma=formulajs.ADD(sigma,Math.pow(range[i] - mean, 2));
	  }
	  return formulajs.DIVIDE(sigma,(n - 1));
	};
