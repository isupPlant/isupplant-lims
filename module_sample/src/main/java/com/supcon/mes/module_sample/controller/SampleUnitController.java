 ...
 * class name 样品结果录入
 */
public class SampleUnitController extends BaseViewController {
    ...
    public SampleUnitController(View rootView) {
        super(rootView);
    }
    ...
    public void onInit() {
        ...
        searchTypeList.add(getRootView().getResources().getString(com.supcon.mes.module_sample.R.string.lims_unit_name));
        searchTypeList.add(getRootView().getResources().getString(com.supcon.mes.module_sample.R.string.lims_unit_code));
    }
    ...
    public void onSearchHistory(EventInfo result) {
        if (result.getEventId() == EventInfo.searchKey) {
            ...
            if (getRootView().getResources().getString(com.supcon.mes.module_sample.R.string.lims_unit_code).equals(resultEntity.key)){
                params.put(Constant.BAPQuery.CODE, resultEntity.result);
            }else if (getRootView().getResources().getString(com.supcon.mes.module_sample.R.string.lims_unit_name).equals(resultEntity.key)){
