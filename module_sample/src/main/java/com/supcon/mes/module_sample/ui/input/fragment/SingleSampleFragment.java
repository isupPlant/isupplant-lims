...
import com.supcon.mes.module_sample.ui.adapter.SingleSampleAdapter;
...
public class SingleSampleFragment extends BaseRefreshRecyclerFragment<SampleEntity> implements SampleListApi.View {
    ...
    private SingleSampleAdapter adapter;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof SingleSampleResultInputActivity) {
    ...
    protected IListAdapter<SampleEntity> createAdapter() {
        adapter = new SingleSampleAdapter(context);
        return adapter;
    }
