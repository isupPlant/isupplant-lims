 ...
 * class name
 */
public class SampleTestDeviceAdapter extends BaseListDataRecyclerViewAdapter<TestDeviceEntity> {
    public SampleTestDeviceAdapter(Context context) {
        super(context);
    }
    ...
    class ViewHolder extends BaseRecyclerViewHolder<TestDeviceEntity>{
        ...
        protected void update(TestDeviceEntity data) {
            if (data != null){
                ...
                ctDeviceType.setEditable(false);
                ctDeviceCode.setEditable(false);
