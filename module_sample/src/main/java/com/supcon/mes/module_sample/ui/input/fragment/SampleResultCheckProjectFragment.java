...
import com.supcon.mes.module_sample.ui.adapter.SampleProjectAdapter;
...
public class SampleResultCheckProjectFragment extends BaseRefreshRecyclerFragment<InspectionSubEntity> implements InspectionSubProjectContract.View,
        InspectionSubProjectColumnContract.View, SampleAnalyseCollectDataContract.View {

    @BindByTag("contentView")
    RecyclerView contentView;

    private SampleProjectAdapter adapter;
    ...
    protected IListAdapter<InspectionSubEntity> createAdapter() {
        adapter = new SampleProjectAdapter(context, contentView);
        return adapter;
    }
    ...
    protected void initListener() {
            ...
            public void onItemChildViewClick(View childView, int position, int action, Object obj) {
                ...
                if (action == 1) {
                    getController(LimsFileUpLoadController.class).
                            showPopup(getActivity(), SampleResultCheckProjectFragment.this)
        ...
        adapter.setOriginalValueChangeListener((SampleProjectAdapter.OriginalValueChangeListener) (value, position) -> {
        ...
        adapter.setDispValueChangeListener(new SampleProjectAdapter.DispValueChangeListener() {
            @Override
