 ...
 * class name 样品结果录入
 */
public class WareStoreController extends BaseViewController {
    ...
    public WareStoreController(View rootView) {
        super(rootView);
    }
    ...
    public void onInit() {
        ...
        searchTypeList.add(getRootView().getResources().getString(com.supcon.mes.module_sample.R.string.lims_ware_store_name));
        searchTypeList.add(getRootView().getResources().getString(com.supcon.mes.module_sample.R.string.lims_ware_store_code));
    }
    ...
    public void onSearchHistory(EventInfo result) {
        if (result.getEventId() == EventInfo.searchKey) {
            ...
            if (getRootView().getResources().getString(R.string.lims_ware_store_code).equals(resultEntity.key)){
                params.put(Constant.BAPQuery.CODE, resultEntity.result);
            }else if (getRootView().getResources().getString(R.string.lims_ware_store_name).equals(resultEntity.key)){
