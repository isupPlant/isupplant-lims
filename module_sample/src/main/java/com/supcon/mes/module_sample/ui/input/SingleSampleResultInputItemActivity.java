...
public class SingleSampleResultInputItemActivity extends BaseRefreshRecyclerActivity<SingleSampleInpectAdapter> implements SingleSampleResultInputContract.View {
    ...
    @Override
    protected IListAdapter<SingleSampleInpectAdapter> createAdapter() {
